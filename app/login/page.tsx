        ...
        <div className="min-h-[80vh] flex items-center justify-center px-6 relative z-10">
            <div className="w-full max-w-sm">
                <div className="text-center mb-10 animate-fade-up">
                    ...
                    <p className="text-sm text-white/20">Sign in to continue to your dashboard</p>
                </div>
                ...
                <p className="text-center text-[13px] text-white/15 mt-8 animate-fade-up animate-delay-2">
                    ...
                    <Link href="/signup" className="text-white/40 hover:text-white transition-colors underline underline-offset-4 decoration-white/10 hover:decoration-white/30">
                        Create one
                    </Link>
                </p>
            </div>
